...
@section ('page_title')
    Movie | Edit a Comment from {{ $comment-> user -> name }}
@endsection
        ...
        <form action="/comment/{{ $comment -> id }}/edit/" method="POST">
            ...
            <fieldset>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="text"
                               value="{{ $comment -> updated_at -> format ('l jS F') }} at {{ $comment -> updated_at -> format ('H:i')  }}"
                               readonly>
                    </div>
                </div>
                ...
                <div class="field is-grouped">
                    ...
                    <p class="control">
                        <a class="button is-danger is-outlined" href="/comment/{{ $comment -> id }}/delete/"><i
                                class="fa fa-times"></i>&nbspDelete</a>
                    </p>
                    <p class="control">
